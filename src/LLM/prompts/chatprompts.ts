...
export const lessBloatPrompt =
  ...
  affirmations, and less over the top. The message will be more between \
  the lines, instead of having everything directly said. It will also not \
  respond to all points that were said, only the most important.\
";
